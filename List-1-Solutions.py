...
last elements in the array, and setall the other elements to be that value. Return the
changed array.'''
...
If the array length is less than 2, just sum upthe elements that exist, returning 0 if

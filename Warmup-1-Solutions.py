...
if each is smiling. We are in trouble if they are both smiling or if neither of them
...
in the range 0..23. We are in trouble if the parrot is talking and the hour is before
